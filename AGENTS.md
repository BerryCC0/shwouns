...
user-level `~/.Codex/settings.json` adds it to PATH for future Codex sessions).
...
`~/.Codex/plans/what-happens-to-a-lucky-meteor.md`. That file is the source of truth
