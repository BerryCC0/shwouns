...
### ProposerSignature
EIP-712 signature payload for proposeBySigs.
...
### ProposalCondensed
Flat, mapping-free view of a proposal for indexers/UIs. Shwouns-native: no clientId
...
## Enums
### ProposalState
All possible proposal lifecycle states.
